...
"""
Copyright 2019 Fellfalla (https://github.com/Fellfalla/)
...
Source: https://github.com/fizyr/keras-retinanet/blob/master/keras_retinanet/bin/train.py
"""
...
def create_models(backbone_retinanet, num_classes, weights, multi_gpu=0,
                  freeze_backbone=False, lr=1e-5, config=None, inputs=(None,None,3)):
...
def parse_args(args):
    ...
    # nuscenes_parser = subparsers.add_parser('nuscenes')
    # nuscenes_parser.add_argument('nuscenes_path', help='Path to dataset directory (ie. ~/data/nuscenes).')
    ...
    group.add_argument('--dataset_type',          help='Resume training from a snapshot.', default='nuscenes')
    group.add_argument('--dataset_path',          help='Resume training from a snapshot.', default='~/data/nuscenes')
    ...
    parser.add_argument('--tensorboard-dir',  help='Log directory for Tensorboard output', default='./tb_logs')
    parser.add_argument('--no-snapshots',     help='Disable saving snapshots.', dest='snapshots', action='store_false')
    parser.add_argument('--no-evaluation',    help='Disable per epoch evaluation.', dest='evaluation', action='store_false')
    parser.add_argument('--freeze-backbone',  help='Freeze training of backbone layers.', action='store_true')
    parser.add_argument('--random-transform', help='Randomly transform image and annotations.', action='store_true')
    parser.add_argument('--image-min-side',   help='Rescale the image so the smallest side is min_side.', type=int, default=360)
...
def main(args=None):
    ...
    if args.snapshot is not None:
        ...
        in_shape = (None, None, len(train_generator.channels))
